...
//EventGroupHandle_t AnnounceLightGroup; // Event Group Declared
//static TaskHandle_t audioTaskHandle = NULL; // Task Handler for xTaskCreate
...
esp_err_t audio_handle_info(PDM_SOUND_TYPE voice)
{
    ...
    // Custom Audio Files
    case SOUND_TYPE_LIGHT0:  
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Audio0.mp3");
        break;
    case SOUND_TYPE_LIGHT25:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Audio25.mp3");
        break;
    case SOUND_TYPE_LIGHT50:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Audio50.mp3");
        break;
    case SOUND_TYPE_LIGHT75:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Audio75.mp3");
        break;
    case SOUND_TYPE_LIGHT100:
        sprintf(filepath, "%s/%s", CONFIG_BSP_SPIFFS_MOUNT_POINT, "Audio100.mp3");
        break;
    }
